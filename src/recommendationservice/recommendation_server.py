...
class RecommendationService(demo_pb2_grpc.RecommendationServiceServicer):
    def __init__(self):
        self.cache = redis.Redis(host=os.environ.get('REDIS_ADDR', 'localhost'), port=6379, db=0)
