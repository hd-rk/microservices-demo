...
type ProductCatalogServiceClient interface {
	...
	GetRecommendations(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SearchProductsResponse, error)
	UpdateProductCount(ctx context.Context, in *UpdateProductCountRequest, opts ...grpc.CallOption) (*UpdateProductCountResponse, error)
}
...
func (c *productCatalogServiceClient) GetRecommendations(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SearchProductsResponse, error) {
	out := new(SearchProductsResponse)
	err := c.cc.Invoke(ctx, "/hipstershop.ProductCatalogService/GetRecommendations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productCatalogServiceClient) UpdateProductCount(ctx context.Context, in *UpdateProductCountRequest, opts ...grpc.CallOption) (*UpdateProductCountResponse, error) {
	out := new(UpdateProductCountResponse)
	err := c.cc.Invoke(ctx, "/hipstershop.ProductCatalogService/UpdateProductCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductCatalogServiceServer interface {
	...
	GetRecommendations(context.Context, *Empty) (*SearchProductsResponse, error)
	UpdateProductCount(context.Context, *UpdateProductCountRequest) (*UpdateProductCountResponse, error)
...
func (UnimplementedProductCatalogServiceServer) GetRecommendations(context.Context, *Empty) (*SearchProductsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecommendations not implemented")
}
func (UnimplementedProductCatalogServiceServer) UpdateProductCount(context.Context, *UpdateProductCountRequest) (*UpdateProductCountResponse, error) {
...
func _ProductCatalogService_GetRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductCatalogServiceServer).GetRecommendations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.ProductCatalogService/GetRecommendations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCatalogServiceServer).GetRecommendations(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProductCatalogService_UpdateProductCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateProductCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductCatalogServiceServer).UpdateProductCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.ProductCatalogService/UpdateProductCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCatalogServiceServer).UpdateProductCount(ctx, req.(*UpdateProductCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductCatalogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductCatalogService_GetRecommendations_Handler,
		},
		{
			MethodName: "UpdateProductCount",
			Handler:    _ProductCatalogService_UpdateProductCount_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
...
type ShippingServiceClient interface {
	...
	TrackOrder(ctx context.Context, in *TrackShipOrderRequest, opts ...grpc.CallOption) (*TrackShipOrderResponse, error)
	UpdateOrderShippingStatus(ctx context.Context, in *UpdateShipOrderStatusRequest, opts ...grpc.CallOption) (*UpdateShipOrderStatusResponse, error)
}
...
func (c *shippingServiceClient) TrackOrder(ctx context.Context, in *TrackShipOrderRequest, opts ...grpc.CallOption) (*TrackShipOrderResponse, error) {
	out := new(TrackShipOrderResponse)
	err := c.cc.Invoke(ctx, "/hipstershop.ShippingService/TrackOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) UpdateOrderShippingStatus(ctx context.Context, in *UpdateShipOrderStatusRequest, opts ...grpc.CallOption) (*UpdateShipOrderStatusResponse, error) {
	out := new(UpdateShipOrderStatusResponse)
	err := c.cc.Invoke(ctx, "/hipstershop.ShippingService/UpdateOrderShippingStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	...
	TrackOrder(context.Context, *TrackShipOrderRequest) (*TrackShipOrderResponse, error)
	UpdateOrderShippingStatus(context.Context, *UpdateShipOrderStatusRequest) (*UpdateShipOrderStatusResponse, error)
...
func (UnimplementedShippingServiceServer) TrackOrder(context.Context, *TrackShipOrderRequest) (*TrackShipOrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrackOrder not implemented")
}
func (UnimplementedShippingServiceServer) UpdateOrderShippingStatus(context.Context, *UpdateShipOrderStatusRequest) (*UpdateShipOrderStatusResponse, error) {
...
func _ShippingService_TrackOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrackShipOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).TrackOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.ShippingService/TrackOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).TrackOrder(ctx, req.(*TrackShipOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ShippingService_UpdateOrderShippingStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateShipOrderStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).UpdateOrderShippingStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.ShippingService/UpdateOrderShippingStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).UpdateOrderShippingStatus(ctx, req.(*UpdateShipOrderStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShippingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ShippingService_TrackOrder_Handler,
		},
		{
			MethodName: "UpdateOrderShippingStatus",
			Handler:    _ShippingService_UpdateOrderShippingStatus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
